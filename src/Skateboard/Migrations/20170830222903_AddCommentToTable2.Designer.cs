...
namespace Skateboard.Migrations
{
    ...
    [Migration("20170830222903_AddCommentToTable2")]
    partial class AddCommentToTable2
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Skateboard.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Skateboard.Models.ApplicationUser")
                        .WithMany("Claims")
